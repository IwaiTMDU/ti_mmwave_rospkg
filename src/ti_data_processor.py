...
def radar_data_callback(data):
	layout = data.range_azimuth_data.layout
	range_azimuth_data = np.array(data.range_azimuth_data.data).reshape([layout.dim[0].size, layout.dim[1].size, layout.dim[2].size])
...
if __name__ == '__main__':
	...
	rospy.Subscriber("/ti_mmwave/radar_raw", RadarRaw, radar_data_callback, queue_size=1)
	rospy.spin()